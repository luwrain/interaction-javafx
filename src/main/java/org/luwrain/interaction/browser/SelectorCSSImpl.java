...
class SelectorCSSImpl extends SelectorAllImpl implements ElementList.SelectorCSS
	{
...
SelectorCSSImpl(boolean visible,String tagName,String styleName,String styleValue)
